...
> 本书已在【方法论】、【代理与网络工具】以及【科学普及】中内嵌融入 2022~2025 现代实操与攻防原理（涵盖 [现代节点自建指南](/method/modern-method)、[现代客户端配置](/proxy/modern-clients) 与 [现代协议演进原理](/abc/evolution)）；书中标记为 **【历史技术归档 · 已淘汰】** 的老旧协议章节（如 SS/SSR、早期 VMess、原生 VPN 等）新读者可直接略过。
