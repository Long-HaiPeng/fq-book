...
* **【重磅】新增 2022~2025 现代对抗技术精选专章**：
  * **协议代际演进史**：拆解 GFW 四次检测范式升级（高熵识别、主动探测、TLS 指纹画像）与破解之道
  * **VLESS + XTLS-Reality**：免域名、免证书借壳大厂站点的抗主动探测机制
  * **Hysteria 2 / TUIC**：基于 UDP/QUIC 与 Brutal 拥塞控制的恶劣弱网与丢包对抗
  * **现代内核与 TUN 模式**：Sing-box 与 Mihomo 底座、Fake-IP 原理及终端命令行全透明接管
* **历史淘汰方案标记**：对 SS/SSR、早期 VMess、传统原生 VPN、GoAgent、Heroku 部署等已被时代淘汰或失效的章节统一添加醒目的【历史技术归档 · 已淘汰】警示框，指导新读者快速跳过无用信息
* 增加速成科学上网篇章
* 增加相关上网方式以及软件配置操作
